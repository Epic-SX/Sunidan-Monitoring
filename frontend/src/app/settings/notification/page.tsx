    ...
    <div>
      ...
      <Box component="form" noValidate>
        ...
        <Paper sx={{ p: 3, mb: 3 }}>
          ...
          <FormControlLabel
            control={<Switch name="line_enabled" />}
            label="LINE通知を有効にする"
          />

          <Alert severity="info" sx={{ mt: 2, mb: 2 }}>
            <AlertTitle>LINE通知について</AlertTitle>
            LINE Messaging APIを使用して通知を送信します。チャネルアクセストークンとユーザーIDが必要です。
          </Alert>
          ...
          <TextField
            ...
            name="line_token"
            placeholder="LINE Developers Consoleで取得したチャネルアクセストークン"
          />
        ...
        <Paper sx={{ p: 3, mb: 3 }}>
          ...
          <Accordion>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography>LINE通知の設定方法</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography variant="body2" paragraph>
                1. <a href="https://developers.line.biz/" target="_blank" rel="noopener noreferrer">LINE Developers</a>にアクセスし、ログインします。
              </Typography>
              <Typography variant="body2" paragraph>
                2. 新しいプロバイダーを作成し、Messaging APIチャネルを作成します。
              </Typography>
              <Typography variant="body2" paragraph>
                3. チャネルアクセストークン（長期）を発行し、上記フォームに入力します。
              </Typography>
              <Typography variant="body2" paragraph>
                4. 作成したLINE Botと友達になり、ユーザーIDを取得します。
              </Typography>
            </AccordionDetails>
          </Accordion>
